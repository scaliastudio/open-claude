...
AppSupportURL=https://github.com/scalia-studio/open-claude/issues
AppUpdatesURL=https://github.com/scalia-studio/open-claude/releases
...
OutputDir=..\dist
OutputBaseFilename=OpenClaude-Setup-{#AppVersion}
